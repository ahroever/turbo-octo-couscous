...
<body>
    ...
    <form action="/chat" method="post">
        <label for="user_input">What is the weather outside?</label><br>
...
async def chat():
    try:
        ...
        assistant = client.beta.assistants.create(
            ...
            description="You can can offer the perfect outfit to wear for the weather outside.",
            model="gpt-4-turbo",
        ...
        thread = client.beta.threads.create(
            messages=[
                {
                    "role": "user",
                    "content": "Tell the user_input what to wear based on the weather they type."
                }
            ]
        )
        ...
        run = client.beta.threads.runs.create(
            ...
            instructions="Output without any regex and brackets and as HTML text."
        )
